/* hello_world_oop.c generated by valac 0.56.0, the Vala compiler
 * generated from hello_world_oop.vala, do not modify */
...
VALA_EXTERN GType demo_hello_world_get_type (void) G_GNUC_CONST ;
static gint demo_hello_world_main (gchar** args,
                            gint args_length1);
VALA_EXTERN DemoHelloWorld* demo_hello_world_new (void);
VALA_EXTERN DemoHelloWorld* demo_hello_world_construct (GType object_type);
static GType demo_hello_world_get_type_once (void);
...
static GType
demo_hello_world_get_type_once (void)
{
	...
	return demo_hello_world_type_id;
}

GType
demo_hello_world_get_type (void)
{
	static volatile gsize demo_hello_world_type_id__once = 0;
	if (g_once_init_enter (&demo_hello_world_type_id__once)) {
		GType demo_hello_world_type_id;
		demo_hello_world_type_id = demo_hello_world_get_type_once ();
		g_once_init_leave (&demo_hello_world_type_id__once, demo_hello_world_type_id);
	}
	return demo_hello_world_type_id__once;
}
