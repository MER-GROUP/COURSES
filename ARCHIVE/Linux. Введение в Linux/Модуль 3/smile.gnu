...
set grid layerdefault linetype 0 linewidth 1.000, \
linetype 0 linewidth 1.000
unset key
...
set arrow 1 from -0.1, 0.26, 0 to 0.18, -0.17, 0 head front nofilled linetype 5 \
linecolor rgb "#f0e442" linewidth 4.000 size first 0.100,40.000,90.000
set parametric
...
set yrange [-1.00000:1.60000 ] noreverse 

plot [t=-pi:pi] sin(t),cos(t) with filledcurve xy=0,0 lt 15, \
