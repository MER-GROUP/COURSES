...
Полученные числа следует вывести на одной строке, 
...
print(
    *list(
        map(
            lambda x: x // 2 if 0 == x % 2 else x,
            filter(
                lambda x: False if 47 < x and 1 == x % 2 else True,
                numbers
            )
        )
    )
...
print(
    *list(
        map(
            ...
            filter(
                lambda x: False if 47 < x and x % 2 else True,
                numbers
            )
        )
    )
