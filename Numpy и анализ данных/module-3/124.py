...
Однажды в далекой стране жил один мудрец, который любил изучать магические силы чисел. 
Он обладал волшебной силой, которая помогала ему находить такие числа, которые скрывали 
в себе удивительные свойства.

Однажды мудрец получил от своих друзей одномерный массив, который содержал в себе множество 
чисел. Мудрец решил применить свою магическую силу, чтобы найти в этом массиве числа, 
которые были больше нуля и меньше единицы, а также удовлетворяли определенным условиям.

Мудрец заметил, что синус некоторых чисел оказывался больше косинуса, а арктангенс других 
чисел оказывался меньше квадратного корня из них. 

Чтобы найти эти числа, мудрец использовал свои знания в области математики и применил 
множество функций библиотеки NumPy. И вам теперь тоже нужно решить эту задачу и вывести 
в одной строке все такие числа, удовлетворяющие данным условиям.
...
stdin = open(file='124.csv', mode='rt', encoding='utf-8', newline='')
