...
Атрибуты
active - указывает, является ли CheckBox активным или нет. Принимает в качестве значения "True" или "False".
...
Пример
Создадим приложение где при нажатии на CheckBox, если поставлена галочка в Label будет выводиться "CheckBox активен", а если нет то "CheckBox не активен:"
...
class CheckBoxApp( App ):
    def build(self):
        self.bl = BoxLayout(orientation = 'horizontal',pos_hint = {'center_x': 0.8 ,'center_y': 1 })
